    ...
    <nav className='main-nav'>
      <ul className='menu flex justify-end'>
        <li className='group relative cursor-pointer px-3.5'>
          <a
            className='flex menu-hover pt-[16px] pb-[16px]'
        ...
        <li className='group relative cursor-pointer pl-3.5 pr-8'>
          ...
          <div className='w-[320px] bg-white border-gray-300 border-[1px] invisible absolute left-[-135px] z-50 py-5 px-4 group-hover:visible'>
            <ul>
              <li className='group/item'>
